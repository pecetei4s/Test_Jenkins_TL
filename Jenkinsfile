...
publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: '/home/tmp/report.html', reportFiles: 'report.html', reportName: 'Report TwistLock'])
}
