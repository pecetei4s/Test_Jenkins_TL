...
stage "Run Container"  
  httpRequest acceptType: 'APPLICATION_JSON', requestBody: '{"Image": "localhost:5000/armadillo-standalone-alpine:2.2.2"}',contentType: 'APPLICATION_JSON',validResponseCodes: '100:501',consoleLogResponseBody: true, httpMode: 'POST', url: 'http://10.23.100.245:2375/containers/create?name=Armadillo'
