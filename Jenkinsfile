...
stage "Build Docker"  
  httpRequest acceptType: 'APPLICATION_JSON', contentType: 'APPLICATION_JSON',validResponseCodes: '100:501', httpMode: 'POST', requestBody: '{"fromImage": "busybox","tag":"latest"}', url: 'http://10.23.100.245:2375/images/create'
