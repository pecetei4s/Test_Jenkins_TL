node(){
def response = httpRequest acceptType: 'APPLICATION_JSON', contentType: 'APPLICATION_JSON', httpMode: 'POST', requestBody: '{"repository": "twistlock"}', url: ' http://10.23.100.245:8090/api/twistlock/reportHtml'
